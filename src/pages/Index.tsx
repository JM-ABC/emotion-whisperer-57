    ...
    <div className="relative min-h-screen overflow-hidden pb-20">
      ...
      <div className="relative z-10 mx-auto max-w-sm px-4 py-0">
        <div className="grid grid-cols-3 gap-y-0 gap-x-2 place-items-center">
          {/* Row 1: center - 기쁨의 섬 */}
          <div className="col-start-2 mt-1" style={{ zIndex: getCount(ISLANDS[0].id) > 0 ? 20 : 10, marginLeft: 6 }}>
          ...
          {/* Row 2: left + right */}
          <div className="col-start-1 mt-1" style={{ zIndex: getCount(ISLANDS[1].id) > 0 ? 20 : 10, marginTop: -4 }}>
          ...
          <div className="col-start-3 mt-1" style={{ zIndex: getCount(ISLANDS[2].id) > 0 ? 20 : 10, marginTop: 6 }}>
          ...
          {/* Row 3: 희망, 슬픔(아래로), 분노 */}
          <div className="mt-2" style={{ zIndex: getCount(ISLANDS[3].id) > 0 ? 20 : 10, marginLeft: 8 }}>
          ...
          <div className="mt-2" style={{ zIndex: getCount(ISLANDS[4].id) > 0 ? 20 : 10, marginTop: -3 }}>
          ...
          <div className="mt-2" style={{ zIndex: getCount(ISLANDS[5].id) > 0 ? 20 : 10, marginRight: 5 }}>
          ...
          <div className="col-start-1 col-span-1 justify-self-end mr-2 mt-1" style={{ zIndex: getCount(ISLANDS[6].id) > 0 ? 20 : 10, marginTop: 4 }}>
          ...
          <div className="col-start-3 col-span-1 justify-self-start ml-2 mt-1" style={{ zIndex: getCount(ISLANDS[7].id) > 0 ? 20 : 10, marginTop: -2 }}>
